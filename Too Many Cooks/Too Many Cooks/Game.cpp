...
{
	rooms.push_back(Room(sf::Vector2f(100, 50), std::string("ASSETS\\IMAGES\\Left_Room.png")));
	rooms.push_back(Room(sf::Vector2f(1000, 50), std::string("ASSETS\\IMAGES\\Right_Room.png")));
